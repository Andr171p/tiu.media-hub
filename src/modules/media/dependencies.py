...
from src.core.media.crud import get_object
...
async def get_object_or_raise_404(db: DBSession, object_id: UUID) -> StoredObjectResponse:
...
object_depends = Depends(get_object_or_raise_404)
