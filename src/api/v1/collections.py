...
from src.core.collections.schemas import CollectionResponse, CreateCollectionDTO
...
async def create_collection(dto: CreateCollectionDTO) -> CollectionResponse: ...
...
async def update_collection() -> CollectionResponse: ...
